            ...
            <Layout title="Page not Found" description="The page you're trying to access cannot be found.">
                <div className="flex-1 overflow-x-hidden overflow-y-auto">
                    <ReaderContainer>
                        ...
                        <div className="text-center text-4xl mt-4 justify-center font-bold">
                            Page not found
                        </div>
                        <p className="text-center mt-4">
                            Looks like the page you&apos;re trying to access is not real.
                        </p>
